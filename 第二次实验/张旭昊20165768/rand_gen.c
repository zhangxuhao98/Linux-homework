...
static int globalvar_init(void)
{
    ...
    */
    my_class = class_create(THIS_MODULE, "rand_gen");
    device_create(my_class, NULL, dev, NULL, "rand_gen");
    return 0;
}
/*
...
static ssize_t globalvar_write(struct file *filp,const char *buf,size_t len,loff_t *off)
{
    ...
    int zz=*((int*)(globalvar.buffer));
    int nowtime=current_kernel_time;
    zz=(zz+nowtime)%zz;
    memcpy(globalvar.buffer,&zz,4);
    return 4;
}
